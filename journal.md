...
By evening, I tried combining some wood shapes like the project just to check fit. Everything aligned… except for one servo arm that didn’t have clearance to swing. I fixed it in CAD immediately.  
...
The Arduino pin mapping(the wiring diagram) is now neatly my mobile background so I don’t forget how much i worked on it.  
...
Added **removable trays** for the coffee-ZnCl₂ mix formula so I can change them without dismantling the chamber.  
...
##  2/7 – 7 hours  
This is “future-proofing” day. Wrote a **Bill of Materials** with everything from the main fans to th rest, all linked to where I found on the internet.  
...
##  3/7 – 4 hours  
Final wrap-up day. Collected every diagram, render, simulation result, and photo into this “Aegis Coffee” repo.  
